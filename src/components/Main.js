			...
			<div className="rectangle">
				<form className="w-form">
					<div className="intro-para">
						...
						Please help Hong Kong by writing to your TD and asking them,</p>
					...
					<div className="formblock">
						...
						<div className="legal">
							We will generate an email template and autofill all the content according to your input data. We are NOT going to hold, store or collect your private information.
						</div>
				...
				<div className="w-richtext">
					...
					<div className="td-letter">
						<p>I am writing to you, my local MP, to call upon you to ensure that Britain upholds its obligations under the terms of the 1984 Sino-British Joint Declaration. </p>
						<p>This legally-binding treaty guaranteed that, for 50 years after 1997, Hongkongers’ rights, freedoms and way of life would be ensured by law. In particular, the Declaration guaranteed that Hongkongers would enjoy fundamental freedoms, including freedom of speech, freedom of the press and freedom of assembly, among others. </p>
						<p>China has breached the terms of this Declaration on many occasions, eroding the executive, legislative and judicial institutions that are supposed to safeguard Hongkongers’ civil and political rights and freedoms. </p>
						<p>The latest breach comes in the form of the Extradition Bill, which would allow dissidents in Hong Kong to be sent to mainland China to face trial. The Bill provoked massive and ongoing protests with nearly two million people taking to the streets. </p>
						<p>In spite of her declaration that “the Bill is dead”, Chief Executive Carrie Lam has not formally withdrawn it. </p>
						<p>Hong Kong’s fundamental freedoms are under attack. Police brutality against protesters and journalists has escalated, shielded by a government that is not accountable to the people. </p>
						<p>Britain has a unique legal, historical and moral responsibility to ensure the Declaration’s implementation. That is why we are calling upon British parliamentarians to impose sanctions on those persons responsible for or complicit in suppressing Hongkongers’ human rights and freedoms. We are also calling upon Britain to include provisions on human rights, civil liberties and democratisation in any post-Brexit agreements with Hong Kong and China. Britain must stand with Hong Kong. </p>
						<p>I urge you to write to the Foreign Secretary and ask them what concrete steps they will take to uphold the Declaration and take steps to put in place sanctions against persons that are involved in undermining freedom in Hong Kong. </p>
						<p>Please send a strong message to our new Prime Minister that Britain must stand by its promises and defend Hong Kong’s freedom. </p>
					</div>
				</div>
			</div>
		</div>
